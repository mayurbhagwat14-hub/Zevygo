...
const Account = () => {
  ...
  const [userProfile, setUserProfile] = useState({
    name: `Verified ${branding?.appName || 'Customer'}`,
    phone: '',
    email: '',
  ...
  if (isLoading) {
    return <Loader fullScreen message="Loading account…" />;
  }

  return (
    <div className="min-h-screen pb-32 relative bg-neutral-50">
        ...
        >
          ...
          >
            ...
            <div className="absolute top-0 right-0 w-48 h-48 rounded-full -mr-20 -mt-20 blur-3xl opacity-[0.15]"
              style={{ backgroundColor: themeColors.brand.cyan }}
            ></div>
            <div className="absolute bottom-0 left-0 w-48 h-48 rounded-full -ml-24 -mb-24 blur-3xl opacity-[0.15]"
              style={{ backgroundColor: themeColors.brand.blue }}
            ></div>
          ...
          {userProfile.plans && userProfile.plans.isActive && (
            <motion.div
              ...
              style={{
                background: `linear-gradient(135deg, ${themeColors.brand.blue} 0%, ${themeColors.brand.cyan} 100%)`,
                boxShadow: `0 20px 40px -12px ${themeColors.brand.blue}40`
              }}
            >
              {/* Decorative elements */}
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-2 gap-3 mb-6">
            ...
            >
              <div className="w-10 h-10 rounded-2xl flex items-center justify-center mb-3 group-hover:scale-110 transition-transform"
                style={{ backgroundColor: `${themeColors.brand.blue}15`, color: themeColors.brand.blue }}
              >
            ...
            >
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-xl flex items-center justify-center bg-gray-50 transition-colors group-hover:bg-opacity-80"
                  style={{ color: themeColors.brand.blue }}>
                  <span className="font-bold">{branding.appName.charAt(0)}</span>
                </div>
