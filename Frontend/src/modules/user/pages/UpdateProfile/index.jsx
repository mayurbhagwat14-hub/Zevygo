        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col items-center justify-center mb-6">
            <div className="relative group">
              ...
              <div
                onClick={handleImageClick}
                className="absolute bottom-1 right-1 p-2 rounded-full cursor-pointer shadow-lg transition-transform active:scale-95 hover:scale-105 bg-primary-600"
              >
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  ...
                  <span className="font-bold text-blue-800 text-sm">Take Photo</span>
                </button>
