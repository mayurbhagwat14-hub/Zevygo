          ...
          <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
            ...
            <div className="flex items-center justify-between p-4 border-b border-gray-100">
              ...
              <button
                ...
                className={`relative w-12 h-6 rounded-full transition-colors duration-200 ${notifications.push ? 'bg-primary-600' : 'bg-neutral-300'}`}
              >
                <span
            ...
            <div className="flex items-center justify-between p-4">
              ...
              <button
                ...
                className={`relative w-12 h-6 rounded-full transition-colors duration-200 ${notifications.email ? 'bg-primary-600' : 'bg-neutral-300'}`}
              >
                <span
