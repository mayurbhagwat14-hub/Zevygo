          ...
          <div className="flex items-center justify-center min-h-screen bg-white">
            <div className="text-center p-6">
              ...
              <button
                ...
                className="px-6 py-3 rounded-xl text-white font-semibold transition-all duration-300 hover:opacity-90 bg-primary-600"
              >
                Refresh Page
              </button>
            </div>
...
const EditServiceForm = lazyLoad(() => import('../pages/Profile/EditServiceForm'));
        ...
        <Suspense fallback={<LoadingFallback />}>
          <PageTransition>
            <Routes>
              ...
              <Route path="/profile/service-form" element={<ProtectedRoute userType="vendor"><EditServiceForm /></ProtectedRoute>} />
              ...
              <Route path="/about-app" element={<ProtectedRoute userType="vendor"><AboutApp /></ProtectedRoute>} />
            </Routes>
          </PageTransition>
        </Suspense>
      </div>
