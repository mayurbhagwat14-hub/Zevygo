  ...
  return (
    <div className="min-h-screen pb-20" style={{ background: themeColors.backgroundGradient }}>
      ...
      <main className="px-4 py-6">
        ...
        <div className="rounded-xl p-3 mb-6 border" style={{ backgroundColor: `${themeColors.brand.blue}0D`, borderColor: `${themeColors.brand.blue}1A` }}>
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs" style={{ color: `${themeColors.brand.blue}CC` }}>
