...
import { FiBell, FiVolume2, FiGlobe, FiInfo, FiLogOut, FiTrash2, FiMapPin, FiChevronRight } from 'react-icons/fi';
      ...
      <main className="px-4 py-6 max-w-lg mx-auto space-y-4">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`relative w-12 h-6 rounded-full transition-colors ${settings.notifications ? 'bg-primary-600' : 'bg-neutral-300'
                  }`}
              >
                <span
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`relative w-12 h-6 rounded-full transition-colors ${settings.soundAlerts ? 'bg-primary-600' : 'bg-neutral-300'
                  }`}
              >
                <span
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="font-bold text-neutral-900">Language</h3>
          </div>
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="font-bold text-neutral-900">About</h3>
          </div>

          <div className="space-y-2 text-sm text-neutral-600">
            <p>App version: 1.0.0</p>
            <p>{branding.appName} partner app</p>
          </div>
        </div>

        <Button type="button" fullWidth onClick={handleLogout} icon={FiLogOut}>
          Logout
        </Button>

        <Button type="button" variant="outline" fullWidth className="border-error-500 text-error-600" onClick={handleDeleteAccount} icon={FiTrash2}>
          Delete account
        </Button>
      </main>
