  ...
  const getContent = () => {
    if (locationDisabled) {
      return {
        ...
        subtitle: `Please turn on your GPS to continue using ${branding.appName} features.`,
        icon: FiSettings
      };
    }
    return {
      title: "ALLOW GPS LOCATION",
      subtitle: `${branding.appName} needs your location to show available services and vendors near you.`,
      icon: FiNavigation
    };
  };
